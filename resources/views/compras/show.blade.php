...
@section('content')
    <x-contentHeader header="{{ __('Mostrar compra') }}">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('Dashboard') }}</a>
        </li>
        <li class="breadcrumb-item"><a href="{{ route('compras.index') }}">{{ __('Compras') }}</a>
        </li>
        <li class="breadcrumb-item active">{{ __('Mostrar Compra') }}</li>
    </x-contentHeader>
    <x-content>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <span class="badge bg-success">{{ $compra->bodega_proyecto->NOMBRE_BODEGA }}</span>
                            </div>
                        </div>
                    </div>
                    <hr>
