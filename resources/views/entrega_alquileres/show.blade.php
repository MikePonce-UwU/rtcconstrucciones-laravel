        ...
        <div class="row justify-content-center">
            <div class="col-10 col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <div class="row align-items-center my-4">
                    <div class="col">
                        <h2 class="h3 mb-0 page-title">{{ __('Mostrar entrega de alquiler') }}</h2>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('Mostrar entrega alquiler') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row my-4">
                    <div class="col-md-12">
                        <div class="card shadow">
                            <div class="card-header text-center h1">Entrega #{{ $entrega->ID_ENTREGA_ALQUILER }} de
                                alquiler
                            </div>
                            <div class="card-body">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        {{ $entrega->HORAS_EXCEDIDAS }}hr(s)
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>{{ __('Pago excedido') }}:</strong>
                                        C${{ $entrega->PAGO_EXCEDIDO }}
                                    </div>
                                </div>
                            </div>
                        </div>
