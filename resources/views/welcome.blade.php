...
<body id="page-top">
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="{{ asset('agency-assets') }}/assets/img/portfolio/1.jpg"
                                alt="..." />
                        </a>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                            ...
                            <img class="img-fluid" src="{{ asset('agency-assets') }}/assets/img/portfolio/2.jpg"
                                alt="..." />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                            ...
                            <img class="img-fluid" src="{{ asset('agency-assets') }}/assets/img/portfolio/3.jpg"
                                alt="..." />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                            ...
                            <img class="img-fluid" src="{{ asset('agency-assets') }}/assets/img/portfolio/4.jpg"
                                alt="..." />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                            ...
                            <img class="img-fluid"
                                src="{{ asset('agency-assets') }}/assets/img/portfolio/5.jpg" alt="..." />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal6">
                            ...
                            <img class="img-fluid"
                                src="{{ asset('agency-assets') }}/assets/img/portfolio/6.jpg" alt="..." />
                        </a>
                        <div class="portfolio-caption">
            ...
            <ul class="timeline">
                <li>
                    <div class="timeline-image"><img class="rounded-circle img-fluid"
                            src="{{ asset('agency-assets') }}/assets/img/about/1.jpg" alt="..." /></div>
                ...
                <li class="timeline-inverted">
                    <div class="timeline-image"><img class="rounded-circle img-fluid"
                            src="{{ asset('agency-assets') }}/assets/img/about/2.jpg" alt="..." /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>March 2011</h4>
                ...
                <li>
                    <div class="timeline-image"><img class="rounded-circle img-fluid"
                            src="{{ asset('agency-assets') }}/assets/img/about/3.jpg" alt="..." /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>December 2015</h4>
                ...
                <li class="timeline-inverted">
                    <div class="timeline-image"><img class="rounded-circle img-fluid"
                            src="{{ asset('agency-assets') }}/assets/img/about/4.jpg" alt="..." /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>July 2020</h4>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-bs-dismiss="modal"><img
                        src="{{ asset('agency-assets') }}/assets/img/close-icon.svg" alt="Close modal" /></div>
                <div class="container">
                        ...
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <img class="img-fluid d-block mx-auto"
                                    src="{{ asset('agency-assets') }}/assets/img/portfolio/1.jpg" alt="..." />
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-fluid d-block mx-auto"
                                    src="{{ asset('agency-assets') }}/assets/img/portfolio/2.jpg" alt="..." />
                                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt
                                    repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae,
                                    nostrum, reiciendis facere nemo!</p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-fluid d-block mx-auto"
                                    src="{{ asset('agency-assets') }}/assets/img/portfolio/3.jpg" alt="..." />
                                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt
                                    repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae,
                                    nostrum, reiciendis facere nemo!</p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-fluid d-block mx-auto"
                                    src="{{ asset('agency-assets') }}/assets/img/portfolio/4.jpg" alt="..." />
                                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt
                                    repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae,
                                    nostrum, reiciendis facere nemo!</p>
    ...
    <!-- Core theme JS-->
    <script src="{{ asset('agency-assets/js/scripts.js') }}"></script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
