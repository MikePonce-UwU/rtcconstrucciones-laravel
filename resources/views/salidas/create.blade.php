        ...
        <div class="row justify-content-center">
            <div class="col-10 col-xs-10 col-sm-10 col-md-10 col-lg-10">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header text-center h1">Formulario de salida</div>
                    <div class="card-body ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('DESCRIPCION_SALIDA', null, ['placeholder' => 'Descripcion', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 ">
                            <a class="btn grey btn-outline-secondary ms-2" href="{{ route('salidas.index') }}">
                                {{ __('Back') }}</a>
